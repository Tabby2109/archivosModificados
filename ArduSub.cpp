...
void Sub::fast_loop()
{
    ...
    if (control_mode != MANUAL && control_mode != MOTOR_DETECT && !control_nuevo) {
    ...
    if(primera_iteracion){
        menu.setVariables(presion_boton1, presion_boton2, presion_boton3, presion_boton4,developer_change,developer_mode,button_assignment);
        primera_iteracion=false;
        menu.add_bool_variable_menu("Activar/desactivar nuevo sistema de control (beta)","sistema nuevo de control activo: %s",control_nuevo);
        menu.add_float_variable_menu("Modificacion parametro P (profundidad)", "valor de P_profundidad: %f", P_profundidad, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro I (profundidad)", "valor de I_profundidad: %f", I_profundidad, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro D (profundidad)", "valor de D_profundidad: %f", D_profundidad, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro P (YAW)", "valor de P_yaw: %f", P_yaw, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro I (YAW)", "valor de I_yaw: %f", I_yaw, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro D (YAW)", "valor de D_yaw: %f", D_yaw, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro P (ROLL)", "valor de P_roll: %f", P_roll, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro I (ROLL)", "valor de I_roll: %f", I_roll, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro D (ROLL)", "valor de D_roll: %f", D_roll, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro P (PITCH)", "valor de P_pitch: %f", P_pitch, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro I (PITCH)", "valor de I_pitch: %f", I_pitch, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro D (PITCH)", "valor de D_pitch: %f", D_pitch, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro Ganancia Forward", "valor de G.Forward: %f", ganancia_forward, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro Ganancia Lateral", "valor de G.Lateral: %f", ganancia_lateral, 0.0, 100.0, 0.01);
        menu.add_float_variable_menu("Modificacion parametro Ganancia Throttle", "valor de G.Throttle: %f", ganancia_throttle, 0.0, 100.0, 0.01);
    }
    menu.run();
    mode_control();
